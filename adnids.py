...
while True:
    ...
    if condition_fed:
        ...
        data_hash = hashlib.sha256(all_node_weights_bytes + all_global_weights_bytes + server_context_ser).hexdigest()
        ...
        while True:
            ...
            if "aggregated weights are ready" in reply['message']:
                while True:
                    ...
                    weight_hash = hashlib.sha256(all_avg_weight_ser_bytes ).hexdigest()
